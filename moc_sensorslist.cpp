...
QT_MOC_LITERAL(1, 12, 13), // "getSensorInfo"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 8), // "sensorId"
QT_MOC_LITERAL(4, 36, 13), // "setSensorInfo"
QT_MOC_LITERAL(5, 50, 4) // "temp"

    },
    "SensorsList\0getSensorInfo\0\0sensorId\0"
    "setSensorInfo\0temp"
};
...
void SensorsList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QString _r = _t->getSensorInfo((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->setSensorInfo((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
